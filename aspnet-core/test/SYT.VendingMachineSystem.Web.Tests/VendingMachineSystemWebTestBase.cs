...
{
    public abstract class VendingMachineSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VendingMachineSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VendingMachineSystemWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<VendingMachineSystemDbContext> action)
        {
            using (var context = IocManager.Resolve<VendingMachineSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<VendingMachineSystemDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<VendingMachineSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VendingMachineSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VendingMachineSystemDbContext, Task<T>> func)
        {
            T result;
