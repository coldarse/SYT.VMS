...
using Shouldly;
using Xunit;
using SYT.VendingMachineSystem.Sessions;

namespace SYT.VendingMachineSystem.Tests.Sessions
{
    public class SessionAppService_Tests : VendingMachineSystemTestBase
    {
