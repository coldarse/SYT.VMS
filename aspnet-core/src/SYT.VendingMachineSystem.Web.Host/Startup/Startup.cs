...
using SYT.VendingMachineSystem.Identity;
...
namespace SYT.VendingMachineSystem.Web.Host.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            return services.AddAbp<VendingMachineSystemWebHostModule>(
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = _apiVersion,
                    Title = "VendingMachineSystem API",
                    Description = "VendingMachineSystem",
                    // uncomment if needed TermsOfService = new Uri("https://example.com/terms"),
                    Contact = new OpenApiContact
                    {
                        Name = "VendingMachineSystem",
                        Email = string.Empty,
                ...
                if (canShowSummaries)
                {
                    ...
                    var applicationXml = $"SYT.VendingMachineSystem.Application.xml";
                    var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                    options.IncludeXmlComments(applicationXmlPath);

                    var webCoreXmlFile = $"SYT.VendingMachineSystem.Web.Core.xml";
